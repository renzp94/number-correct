...
test('5.4 % 2 = 1.4', () => {
  expect(mod(5.4, 2)).toBe('1.4')
})

test('5 % 2.5 = 0', () => {
  expect(mod(5, 2.5)).toBe('0')
})

test('-1.2 % 0.2 = 0', () => {
  expect(mod(-1.2, 0.2)).toBe('0')
})

test('-1.2 % 0.7 = -0.5', () => {
  expect(mod(-1.2, 0.7)).toBe('-0.5')
})
...
test('-1 % 0.2 = 0', () => {
  expect(mod(-1, 0.2)).toBe('0')
})

test('-1.3 % 0.2 = 0.1', () => {
  expect(mod(-1.3, 0.2)).toBe('-0.1')
})

test('-1.41 % 0.2 = -0.01', () => {
  expect(mod(-1.41, 0.2)).toBe('-0.01')
})
